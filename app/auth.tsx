...
function Auth({ signup = false }: { signup?: boolean }) {
  ...
  if (checkingSession) {
    return <><Header/><main className="auth"><div className="auth-card"><div className="eyebrow">TutorVerse secure access</div><h1>Checking your session…</h1><p>One moment.</p></div></main><Footer/></>
  }
