...
const modes = [
  ...
  { title: 'Home Tuition', text: 'One-to-one attention at your home.', image: 'https://img1.wsimg.com/isteam/ip/d607fd78-9c06-4c12-a1c4-7708daae514a/home-tutor-student-bharti-tutors-delhi-550c8eb.png', icon: 'H', tone: 'bg-[#e1f2fb]', accent: 'text-[#1466b8]' },
  { title: 'Online Tuition', text: 'Learn from anywhere. Same great quality.', image: 'https://raw.githubusercontent.com/Protutor-Home-Tuitions/online-class/main/images/Student_attending_online_202603312338%20%282%29.jpeg', icon: 'O', tone: 'bg-[#f5e5f8]', accent: 'text-[#7041c8]' },
  { title: 'For Students & Parents', text: 'Track progress and get regular updates.', image: 'https://www.brighttuitioncare.com/assets/about-us-DuXW9vDZ.jpg', icon: 'P', tone: 'bg-[#fff1d8]', accent: 'text-[#ec8314]' },
];
    ...
    <section className="border-b border-[#e9eeeb] bg-[#f7fbf8]">
      <div className="mx-auto max-w-[1180px] px-5 py-6 sm:px-8 sm:py-8">
        <div className="grid items-center overflow-hidden rounded-[28px] border border-[#dfece4] bg-white shadow-[0_10px_35px_rgba(27,67,48,.07)] lg:grid-cols-[1.05fr_.95fr]">
          ...
          <div className="relative h-[270px] overflow-hidden sm:h-[310px] lg:h-[360px]"><img src="https://img1.wsimg.com/isteam/ip/d607fd78-9c06-4c12-a1c4-7708daae514a/home-tutor-student-bharti-tutors-delhi-550c8eb.png" alt="Professional lady tutor teaching one student at home" className="h-full w-full object-cover"/><div className="absolute left-5 top-5 rounded-2xl bg-white/95 px-5 py-4 shadow-xl"><div className="text-base font-black leading-tight text-[#183a5b]">Learn.<br/><span className="text-[#168b50]">Practice. Grow.</span></div><div className="mt-2 h-1 w-12 rounded-full bg-[#f08a19]"/></div><div className="absolute bottom-5 right-5 rounded-2xl bg-[#183a5b] px-4 py-3 text-sm font-extrabold text-white shadow-xl">Personal. Simple. Managed.</div></div>
        </div>
      </div>
    </section>
